Imports System.IO
Public Class frmImageCorruptionChecking
    ...
    '    Dim ImgExtension As String = "JPG"
...
OUT:
    ...
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        Me.Close()
    End Sub
    Private Sub ChangeFile(ByVal targetDir As String)
        Try
            ...
            For Each fi In di.GetFiles("*." & ImgExtension)
                ...
                Try
                    If fileNM.EndsWith("_L." & ImgExtension) Then
                        ...
                        If chkDeleteCorruptedImage.Checked Then
                            fi.Delete()
                        End If
                    Else
                        Try
                        ...
                        Finally
                            ...
                            pct.Dispose()
                        End Try
                        If chkDeleteCorruptedImage.Checked AndAlso blnCorrupted Then
                            fi.Delete()
                        End If
                    End If
                Catch ex As Exception
